...
export const PLUGINS_REPO_URL = `https://github.com/${OWNER}/SiliconChat-Awesome-Plugins`;
...
5. EXAMPLE INTERACTION:
  ...
  "params": {
    "name": "write_file",
    "arguments": {
      "path": "/Users/river/dev/siliconchat/test/joke.txt",
...
\`\`\`
   ...
   \`\`\`json:mcp:filesystem
   {
      "method": "write_file",
      "params": {
        "path": "SiliconChat_Information.txt",
        "content": "1"
    }
   }
   \`\`\`
