...
const cn = {
  ...
  Auth: {
    ...
    TopTips:
      "🥳 SiliconChat AI 首发优惠，立刻解锁 OpenAI o1, GPT-4o, Claude-3.5 等最新大模型",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Danger: {
      ...
      Clear: {
        Title: "退出登录并清除所有数据",
        SubTitle: "退出登录并清除所有聊天、设置数据",
        Action: "退出登录",
        Confirm: "确认退出登录并清除所有聊天、设置数据？",
      },
    },
    Lang: {
    ...
    Access: {
      SaasStart: {
        Title: "使用 SiliconChat AI",
        Label: "（性价比最高的方案）",
        SubTitle:
          "由 SiliconChat 官方维护, 零配置开箱即用，支持 OpenAI o1, GPT-4o, Claude-3.5 等最新大模型",
        ChatNow: "立刻对话",
      },
      AccessCode: {
        Title: "访问密码",
